...
(defun indentation-tree-move-to-parent ()
  ...
  (while (and (> (current-column) 0) (> (line-number-at-pos) 1) (or (eolp) (>= (current-column) indentation-tree-current-indentation)))
    (forward-line -1)
    (back-to-indentation)))
...
(defun indentation-tree-move-to-child ()
  ...
  (back-to-indentation)
  (setq indentation-tree-current-indentation (current-column))
  (while (and (not (eobp)) (or (eolp) (= (current-column) indentation-tree-current-indentation)))
    (forward-line 1)
    (back-to-indentation))
  (if (< (current-column) indentation-tree-current-indentation)
      (progn 
        ...
        (back-to-indentation))
    (setq indentation-tree-current-indentation (current-column))
    (while (or (eolp) (and (not (eobp)) (equal (current-column) indentation-tree-current-indentation)))
      (forward-line 1)
      (back-to-indentation))
    (forward-line -1)
    (back-to-indentation)
